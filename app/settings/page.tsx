...
export default function SettingsPage() {
  ...
  return (
    <main className="min-h-screen" style={{ background: 'var(--background)' }}>
      {/* Busy overlay — covers the apply-frequency / toggle round trip and the
          subsequent reload so the screen never looks frozen. */}
      {reviewBusy && (
        <div
          className="fixed inset-0 z-50 flex flex-col items-center justify-center gap-3 backdrop-blur-sm"
