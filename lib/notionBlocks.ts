 ...
 * Highlights are always separated by an empty paragraph when created, so this
 * is the only reliable delimiter. Mixed content (bullets + paragraphs) within
 * a single highlight stays in one group.
 */
